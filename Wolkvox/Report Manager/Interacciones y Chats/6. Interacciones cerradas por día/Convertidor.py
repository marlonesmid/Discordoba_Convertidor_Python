...
RUTA_BASE       = r"C:\Convertidor\Wolkvox\Report Manager\Interacciones y Chats\6. Interacciones cerradas por día"
ARCHIVO_ENTRADA = os.path.join(RUTA_BASE, 'Interacciones_cerradas_por_dia.json')
ARCHIVO_SALIDA  = os.path.join(RUTA_BASE, 'Interacciones_cerradas_por_dia.sql')
TABLA = "QUIRAMA.dbo.Integracion_Wolkvox_ReportManager_InteraccionesyChats_InteraccionesCerradasPorDia"

# 'id' es IDENTITY — SQL Server lo genera automáticamente
COLUMNAS_SQL = [
    'date', 'interactions', 'close_time', 'updated_at'
]
