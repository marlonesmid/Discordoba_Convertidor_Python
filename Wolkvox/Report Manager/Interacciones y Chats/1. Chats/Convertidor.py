...
RUTA_BASE       = r"C:\Convertidor\Wolkvox\Report Manager\Interacciones y Chats\1. Chats"
ARCHIVO_ENTRADA = os.path.join(RUTA_BASE, 'chats.json')
ARCHIVO_SALIDA  = os.path.join(RUTA_BASE, 'inserts_chats.sql')
TABLA = "QUIRAMA.dbo.Integracion_Wolkvox_ReportManager_InteraccionesyChats_Chats"

# Campos enteros — se insertan sin comillas
CAMPOS_INT = {'customer_chars', 'agent_chars', 'ASA', 'agent_answers'}

# 'id' es IDENTITY — SQL Server lo genera automáticamente
COLUMNAS_SQL = [
    'conn_id', 'channel', 'date', 'routing', 'customer_name',
    'customer_email', 'customer_phone', 'customer_chars', 'assignment_time',
    'agent_average_response_time', 'agent_id', 'agent_name', 'agent_dni',
    'agent_chars', 'time_on_agent', 'chat_duration', 'cod_act',
    'description_cod_act', 'transfer', 'transfer_type', 'comments',
    'customer_id', 'skill_id', 'ASA', 'last_participant_who_spoke',
    'extra_field', 'comment', 'user_id', 'feeling', 'agent_answers',
    'updated_at'
]
