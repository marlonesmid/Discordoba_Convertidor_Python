...
RUTA_BASE = r"C:\Convertidor\Wolkvox\Report Manager\CDR\1. Detalle de llamadas"
ARCHIVO_ENTRADA = os.path.join(RUTA_BASE, 'datos.json')
ARCHIVO_SALIDA = os.path.join(RUTA_BASE, 'inserts_datos.sql')
TABLA = "QUIRAMA.dbo.Integracion_Wolkvox_detalleDeLlamadas"

# Columnas en el orden del JSON recibido
COLUMNAS_SQL = [
    'agent_name', 'date', 'destiny', 'telephone', 'cost',
    'time_seg', 'time_min', 'cod_act', 'description_cod_act',
    'cod_act_2', 'description_cod_act_2', 'type_interaction',
    'customer_id', 'hang_up', 'campaign_id', 'conn_id',
    'skill_id', 'skill_name', 'agent_id', 'comment',
    'updated_at'  # Se genera automáticamente con la fecha/hora de ejecución
]
...
def procesar():
    try:
        ...
        # El JSON tiene estructura: { "code": "200", "data": [...] }
